...
CREATE TABLE TAREAS(
  cod_proyecto      NUMBER(5)       CONSTRAINT tareas_fk1       REFERENCES PROYECTOS(cod_proyecto)
                                                                ON DELETE CASCADE,
  cod_tarea         NUMBER(3),
...
CREATE TABLE EJECUCIONES(
    ...
    cod_tarea       NUMBER(3),
    cod_pers        NUMBER(6)       CONSTRAINT ejecuciones_fk2 REFERENCES PERSONAL(cod_pers)
                                                                ON DELETE CASCADE,
    ...
    fecha_inicio    DATE                                        DEFAULT TO_DATE('31/10/2024', 'dd/mm/yyyy'),
                                    ...
                                    CONSTRAINT ejecuciones_fk1  FOREIGN KEY (cod_proyecto, cod_tarea)
                                                                REFERENCES TAREAS (cod_proyecto, cod_tarea)
);
--EJERCICIO2
--A
