...
import hoja31.ej1.version2Clases.*;

import java.io.File;
import java.util.Scanner;

public class MainEj1V2 {
    public static void main(String[] args) {
        int opcion=0;
        String lectura;
        MovimientosV2 movimientos = new MovimientosV2();
        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println(movimientos.añadirMovimiento(nombre, cantidad, archivo) ? "hoja31.ej1.Clases.Movimiento añadido con exito" : "Error al añadir el movimiento");
                ...
                case 2:
                    ...
                    do {
                        non = false;
                        System.out.println("Indica un movimiento:");
